...
class AddTodo extends Component {
  ...
  // Set value of due date (another handleChange function)
  setDueDate = (event) => {
    this.setState({
  ...
  handleSubmit = (event) => {
    ...
    if (this.state.content.trim()) {
      ...
      this.setState({
        content: "",
        date: "",
        due: null   // might have to change this if errors arise!!!
      });
    }
  };
  render() {
      ...
      <div>
        ...
        <LocalizationProvider dateAdapter={AdapterDateFns}>         
          <DesktopDatePicker
            id="new-item-date"
            label="Due Date"
            value={this.state.due} // maybe change this value if errors arise!!!
